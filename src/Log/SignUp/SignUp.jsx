...
const SignUp = () => {
    ...
    const submitForm = (e) => {
        ...
        const repeat_password = form.get('floating_repeat_password');
        const first_name = form.get('floating_first_name');
        const last_name = form.get('floating_last_name');
        const phone = form.get('floating_phone');
        const company = form.get('floating_company');
        const user = { email, password, repeat_password, first_name, last_name, phone, company };
        console.log(user);
        e.target.reset();
    ...
    return (
        <div className="py-10  lg:py-24 px-5">
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 items-center'>
                ...
                <form onSubmit={submitForm} className="max-w-md w-[18rem] lg:w-[32rem] mx-auto">
